...
function Works () {
    return (
        <div class="grid grid-cols-[1fr_2px_1fr] grid-rows-8 mt-14 gap-x-6">         
            ...
            <Border />
            <ImageRight link="https://tcoquery.github.io/REACT-Where-s-Waldo/" imgSrc={waldo} height="320" width="620" alt="Where's Waldo React project screenshot"/>
            <ImageLeft link="https://tcoquery.github.io/REACT-CV-Maker/" imgSrc={cv} height="320" width="620" alt="CV Builder React project screenshot"/>
            <Border />
            ...
            <Border />
            <ImageRight link="https://tcoquery.github.io/JS-To-Do-List/" imgSrc={todolist} height="320" width="620" alt="To Do list Javascript project screenshot"/>
            <ImageLeft link="https://tcoquery.github.io/JS-Battleship/" imgSrc={battleship} height="320" width="620" alt="Battleship Javascript project screenshot"/>
            <Border />
            ...
            <Border />
            <ImageRight link="#" imgSrc={facebook} height="320" width="620" alt="Facebook Ruby on Rails project screenshot"/>
            <ImageLeft link="#" imgSrc={flightbooker} height="320" width="620" alt="Flight Booker Ruby on Rails project screenshot"/>
            <Border />
            ...
            <Border />
            <ImageRight link="https://replit.com/@tcoquery/Mastermind?v=1" imgSrc={mastermind} height="320" width="620" alt="Mastermind Ruby project screenshot"/>
            <ImageLeft link="https://replit.com/@tcoquery/Hangman?v=1" imgSrc={hangman} alt="Hangman Ruby project screenshot"/>
            <Border />
